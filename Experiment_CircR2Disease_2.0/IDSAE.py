...
# ---------------------------------------使用下采样的方法获取负样本-----------------------------------------------------
def downsample_negative_samples(NEGATIVE_SAMPLE_CHA_ALL, positive_sample_number):
    negative_sample_count = min(len(NEGATIVE_SAMPLE_CHA_ALL), positive_sample_number)
    NEGATIVE_SAMPLE_CHA = random.sample(NEGATIVE_SAMPLE_CHA_ALL.tolist(), negative_sample_count)
