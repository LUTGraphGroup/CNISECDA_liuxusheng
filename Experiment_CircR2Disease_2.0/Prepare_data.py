...
'''
基于CircR2Disease v2.0数据库整合微生物和疾病的各种相似度
'''
...
def circRNA_functional_similarity():
    # 修改目录即可
    # circRNA、疾病关联矩阵
    CD = pd.read_excel("../Dataset/CircR2Disease_2.0/Association Matrixs.xlsx", header=None)
    # 疾病语义相似性矩阵
    DS = pd.read_excel("../Dataset/CircR2Disease_2.0/disease_semantic_similarity.xlsx", header=None)
...
if __name__ == '__main__':
    ...
    circRNA_functional_similarity.to_csv("../Dataset/CircR2Disease_2.0/circRNA_functional_similarity.csv")
    circRNA_GIP_similarity.to_csv("../Dataset/CircR2Disease_2.0/circRNA_GIP_similarity.csv")
    disease_GIP_similarity.to_csv("../Dataset/CircR2Disease_2.0/disease_GIP_similarity.csv")
    ...
    circRNA_similarity_fusion_matrix.to_csv("../Dataset/CircR2Disease_2.0/circRNA_similarity_fusion_matrix.csv")

    disease_do_similarity = pd.read_excel("../Dataset/CircR2Disease_2.0/disease_semantic_similarity.xlsx", header=None)
    ...
    disease_similarity_fusion_matrix.to_csv("../Dataset/CircR2Disease_2.0/disease_similarity_fusion_matrix.csv")
